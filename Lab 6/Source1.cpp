//Вариант 2. Написать функцию, которая в числе x устанавливает 0 в n бит, 
//находящихся справа от позиции p, остальные биты остаются без изменения.
...
int main() {
    ...
    while (flag) {
        ...
        case(2):
            ...
            printf("Введите количество бит n и позицию p, справа от которой следует установить 0. \n");
            scanf_s("%d %d", &n, &p);
